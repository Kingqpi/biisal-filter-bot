...
#main variables
API_ID = int(environ.get('API_ID', '14860877'))
API_HASH = environ.get('API_HASH', 'ad3fa09cb86f375a851216ea26b14382')
BOT_TOKEN = environ.get('BOT_TOKEN', '')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6999303719').split()]
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002205131365'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002214542716'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002214542716'))
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "fc8a95778f095f7c8e044f616ea8530bcc52766a")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'instantlinks.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "47aebb8e71b6d437cadb79f26f19a4df46250c20")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'adrinolinks.com')
...
REF_PREMIUM = 30
PREMIUM_POINT = 1500
auth_channel = environ.get('AUTH_CHANNEL', '-1002175774479')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002181983453'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002175774479')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1008000054678'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002175774479'))
